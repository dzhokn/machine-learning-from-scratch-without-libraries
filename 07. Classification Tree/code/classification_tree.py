...
class ClassificationTree():
    ...
    def get_best_split(self,
        ...
        Wa rank the candidate splits by `information gain` (gini index) and always pick the one with highest `information gain`.
    ...
    def gini_index(self, Y: np.ndarray):
        '''
...
# Load data
students_df = pd.read_csv("07. Classification Tree/data/students_dataset.csv.gz", compression="gzip")
